...
namespace Shusha_project_BackUp.Data.Migrations
{
    ...
    [Migration("20251026120352_Expenses_total")]
    partial class Expenses_total
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shusha_project_BackUp.Data.Budget", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("egg")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("herd")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Shusha_project_BackUp.Data.Expenses", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Shusha_project_BackUp.Data.Expenses_total", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Shusha_project_BackUp.Data.HerdSales", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("NO_br_herd")
                        .HasColumnType("int");

                    b.Property<int>("NO_wh_herd")
                        .HasColumnType("int");

                    b.Property<double>("br_price_kilo")
                        .HasColumnType("float");

                    b.Property<double>("req_total_br")
                        .HasColumnType("float");

                    b.Property<double>("req_total_wh")
                        .HasColumnType("float");

                    b.Property<double>("total_request_proceed")
                        .HasColumnType("float");

                    b.Property<double>("weight_brown")
                        .HasColumnType("float");

                    b.Property<double>("weight_white")
                        .HasColumnType("float");

                    b.Property<double>("wh_price_kilo")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Shusha_project_BackUp.Data.Proceeds_Totals", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("broken_Egg")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("double_Egg")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("waste_fees")
                        .HasColumnType("decimal(18,2)");

                    b.HasKey("id");

                    b.ToTable("proceeds_Totals");
                });
            ...
            modelBuilder.Entity("Shusha_project_BackUp.Data.Total_Traders", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<double>("Total_traders")
                        .HasColumnType("float");

                    b.Property<double>("requestProceed")
                        .HasColumnType("float");

                    b.HasKey("id");

                    b.ToTable("Total_Traders");
                });

            modelBuilder.Entity("Shusha_project_BackUp.Data.TraderSales", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("BrokenEggPrice")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("RequestProceed")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("WhiteEggPrice")
                        .HasColumnType("decimal(18,2)");

                    b.Property<DateOnly>("date")
                        .HasColumnType("date");

                    b.Property<string>("name_ofTrader")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id");

                    b.ToTable("TraderSales");
                });
            ...
            modelBuilder.Entity("Shusha_project_BackUp.Models.totalProduction_vm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("total_brokenEggs")
                        .HasColumnType("int");

                    b.Property<int>("total_brownEggs")
                        .HasColumnType("int");

                    b.Property<int>("total_doubleEggs")
                        .HasColumnType("int");

                    b.Property<int>("total_whiteEggs")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.ToTable("totalProduction_Vms");
                });
